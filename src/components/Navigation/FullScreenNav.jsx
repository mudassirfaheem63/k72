    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden" style={{ zIndex: 30 }}>
        ...
        <div className="flex w-full justify-between p-2 items-start">
          ...
          <div
            className="h-18 w-18 relative cursor-pointer"
            onClick={() => setNavOpen(false)}
          >
            <div className="h-25 w-1 origin-top -rotate-45 bg-[#d3fd50] absolute"></div>
            <div className="h-25 w-1 origin-top right-0 rotate-45 bg-[#d3fd50] absolute"></div>
          </div>
        </div>
        ...
        <div id="all-links" className="py-20">
          ...
          <div className="link origin-top relative border-t border-white overflow-hidden">
            <h1 className="font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Projects</h1>
            <div className="moveLink flex absolute top-0 text-black bg-[#d3fd50]">
              <div className="flex moveX items-center">
                <h2 className="whitespace-nowrap font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Pour Toit Voir</h2>
                <img className="w-48 shrink-0 rounded-full h-20 object-cover" src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
                <h2 className="whitespace-nowrap font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Pour Toit Voir</h2>
                <img className="w-48 shrink-0 rounded-full h-20 object-cover" src="https://k72.ca/uploads/caseStudies/PJC/Thumbnails/PJC_SiteK72_Thumbnail_640x290-640x290.jpg" alt="" />
              </div>
              <div className="flex moveX items-center">
                <h2 className="whitespace-nowrap font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Pour Toit Voir</h2>
                <img className="w-48 shrink-0 rounded-full h-20 object-cover" src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
          ...
          <div className="link origin-top relative border-t border-white overflow-hidden">
            <h1 className="font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Agence</h1>
            <div className="moveLink flex absolute top-0 text-black bg-[#d3fd50]">
              <div className="flex moveX items-center">
                <h2 className="whitespace-nowrap font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Pour Toit Voir</h2>
                <img className="w-48 shrink-0 rounded-full h-20 object-cover" src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
          ...
          <div className="link origin-top relative border-t border-white overflow-hidden">
            <h1 className="font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Contact</h1>
            <div className="moveLink flex absolute top-0 text-black bg-[#d3fd50]">
              <div className="flex moveX items-center">
                <h2 className="whitespace-nowrap font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Pour Toit Voir</h2>
                <img className="w-48 shrink-0 rounded-full h-20 object-cover" src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
          ...
          <div className="link origin-top relative border-y border-white overflow-hidden">
            <h1 className="font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Blogs</h1>
            <div className="moveLink flex absolute top-0 text-black bg-[#d3fd50]">
              <div className="flex moveX items-center">
                <h2 className="whitespace-nowrap font-[font2] text-[8vw] text-center uppercase pt-3 leading-[0.8]">Pour Toit Voir</h2>
                <img className="w-48 shrink-0 rounded-full h-20 object-cover" src="https://k72.ca/uploads/caseStudies/WIDESCAPE/WS---K72.ca---MenuThumbnail-640x290.jpg" alt="" />
